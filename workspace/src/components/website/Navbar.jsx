                ...
                <div className="hidden md:flex space-x-8 items-center">
                    {isHome ? (
                        <>
                            ...
                            <Link to="/login" className="px-4 py-2 bg-arq-accent/20 hover:bg-arq-accent/30 text-arq-accent border border-arq-accent/50 rounded-lg transition-all text-sm font-medium">
                                Accedi
                            </Link>
                        </>
                    ) : (
