        ...
        <footer id="contatti" className="py-12 border-t border-white/5 bg-black">
            <div className="container mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-6 text-xs text-gray-600 mb-4">
                    <Link to="/statuto" className="hover:text-arq-accent transition-colors">Statuto</Link>
                    <Link to="/privacy-policy" className="hover:text-arq-accent transition-colors">Privacy Policy</Link>
                    <Link to="/cookie-policy" className="hover:text-arq-accent transition-colors">Cookie Policy</Link>
                </div>
