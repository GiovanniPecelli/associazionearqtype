        ...
        <ToastContext.Provider value={{ showToast }}>
            ...
            <div className="fixed top-24 right-4 z-[200] flex flex-col gap-2 pointer-events-none">
                {toasts.map((toast) => (
                    <div
                        key={toast.id}
                        className={`pointer-events-auto transform transition-all duration-300 animate-slide-in-right hover:scale-105
              ...
              backdrop-blur-md border px-4 py-3 rounded-xl shadow-2xl flex items-center gap-3 min-w-[300px] max-w-md
            `}
                    >
                        {/* Icons based on type */}
